...
namespace dlib 
{
    // gas_cst -- Gas constant   ( Joule / (K * mol)  )
    const double gas_cst = 8.31446261815324;

    // avogadro_cst -- Avogadro Number ( 1 / mol )
    const double avogadro_cst = 6.02214086e23;

    // boltzmann_cst --  Boltzmann Constant ( Joules/K ) 
    const double boltzmann_cst = 1.380658e-23;
